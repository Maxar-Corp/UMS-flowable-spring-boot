...
class UmsTaskPostDtoTest {
    ...
    void umsTaskPostDto() {
        ...
        assertInstanceOf(String.class, umsTaskPostDto.getPriority());
        ...
        assertInstanceOf(Integer.class, umsTaskPostDto.getLoe());
